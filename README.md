...
| 版本 | 日期 | 主要变更 |
|---|---|---|---|
| v0.4.0 | 2026-05-27 | 架构重构：planner/builder 从 primary 降级为 subagent，maintainer 成为所有项目工作的唯一入口；builder maxSteps 160→60；删除 templates/user-prompts/（旧直接调用模式）；developer-environment.template.md 移至 templates/；AGENTS.md / README / docs 工作流全面更新为 maintainer 统一调度模式 |
